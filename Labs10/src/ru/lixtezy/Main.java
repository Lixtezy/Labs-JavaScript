...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        bb = new BufferedReader(new FileReader("src/ru/lixtezy/file.txt"));
        String Line;
        String result=" ";
        ...
        String file= "src/ru/lixtezy/file.txt";
        String file2= "src/ru/lixtezy/file2.txt";
        ...
        sf.func("C:\\Users\\pro50\\OneDrive\\Рабочий стол\\Программирование\\JavaScript\\Labs10", "file.txt");

        SearchTextInFile st= new SearchTextInFile();
        String filePath = "C:\\Users\\pro50\\OneDrive\\Рабочий стол\\Программирование\\JavaScript\\Labs10";
    }
}
